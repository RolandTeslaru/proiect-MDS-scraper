...
function Set({ className, ...props }: React.ComponentProps<"fieldset">) {
  return (
    <fieldset
      data-slot="field-set"
...
function Label({
  ...
  return (
    <BaseLabel
      ...
      className={cn(
        `has-data-[state=checked]:bg-primary/1 
         has-data-[state=checked]:border-primary/20
         dark:has-data-[state=checked]:bg-primary/5 
         gap-2 
         ...
         *:data-[slot=field]:p-2.5 
         group/field-label 
         peer/field-label flex w-fit leading-snug`,
...
function Separator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <BaseSeparator className="absolute inset-0 top-1/2" />
      {children && (
        <span
