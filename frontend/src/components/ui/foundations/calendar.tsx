    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none !shadow-none",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <SystemIcons.ChevronLeft className={cn("size-4", className)} {...props} />
            )
          }
          ...
          return (
            <SystemIcons.ChevronDown className={cn("size-4", className)} {...props} />
          )
        },
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        `flex flex-col w-full aspect-square size-auto min-w-(--cell-size)
