...
export const Items = ({ children, className }: ListItemsProps) => (
...
export const Header = (props: ListHeaderProps) =>
  'children' in props ? (
    props.children
  ) : (
    <div
...
export const Group = ({ id, children, className }: ListGroupProps) => {
